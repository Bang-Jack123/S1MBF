...
"""%s
 ...
 - author      : Patrix
 - facebook    : facebook.com/Bang jack.28
 - fanspage    : facebook.com/100022086172556
 - whatsap     : 081329511668
 - github      : github.com/Bang-Jack123
 - script name : z2
 - version     : 1.1
...
\033[31;1m/ ___|_ _|  _ \|  \/  | __ )|  ___|%s %sFB     : BANG JACK
\033[31;1m\___ \| || | | | |\/| |  _ \| |_   %s %sGITHUB : BANG-JACK123
\033[37;1m ___) | || |_| | |  | | |_) |  _|  %s %sWA ME  : 081329511668
\033[37;1m|____/___|____/|_|  |_|____/|_|	   %s %sYT     : KANG TTRIAL

%s[%s*%s] AUTHOR : %sDIHI-Xcrack
%s[%s*%s] ---------------------------------------------------
[%s*%s] IP ADRESS : %s%s
